...
import { Button, Modal, message, Card, Badge, Alert } from "antd";
import { 
  CheckCircleOutlined, 
  StopOutlined, 
...
export default function AccountStatusPage() {
  ...
  const backendUrl = "https://hyre.hyrelancer.com/api/account/status";
    ...
    <div className="min-h-screen bg-gray-50">
            ...
            message={
              <div className="flex items-center justify-center space-x-2">
                ...
                <span className="font-medium">
                  Account status updated! Your profile is now {accountStatus === 1 ? "visible" : "hidden"} to customers.
                </span>
              </div>
            }
      ...
      <div className="container mx-auto px-4 py-12 lg:py-20 max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <Card className={`${getStatusColor()} border-2 shadow-lg rounded-2xl`}>
            <div className="text-center p-4">
              ...
              <p className="text-sm text-gray-600 mt-2">
                {accountStatus === 1 ? "Your account is fully operational" : "Your account is temporarily disabled"}
              </p>
            </div>
          </Card>
          ...
          <Card className="bg-white border-2 border-gray-200 shadow-lg rounded-2xl">
            <div className="text-center p-4">
              ...
              <p className="text-sm text-gray-600 mt-2">
                {accountStatus === 1 ? "Customers can find and contact you" : "Your profile is not searchable"}
              </p>
            </div>
          </Card>
        </div>
        ...
        <Card className="shadow-2xl rounded-3xl bg-white border-0 overflow-hidden">
          <div className="bg-[#3d5999] text-white p-6 text-center rounded-t-3xl">
          ...
          <div className="p-8 text-center">
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-xl">
              <p className="text-sm text-gray-600">
                ...
                {accountStatus === 1 
                  ? "Deactivating temporarily removes your profile from customer searches"
          ...
          <div className={`p-4 rounded-xl mb-4 ${accountStatus === 1 ? "bg-red-50" : "bg-green-50"}`}>
            ...
            <div className="space-y-2 text-sm">
              ...
              <ul className="ml-4 space-y-1">
                ...
                <li>• {accountStatus === 1 ? "Temporarily disable" : "Fully restore"} your account functionality</li>
              </ul>
            </div>
          </div>
