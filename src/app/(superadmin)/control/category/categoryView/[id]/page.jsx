          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            <div className="overflow-hidden bg-white rounded-xl border shadow-sm border-slate-200">
              <div className="relative">
                {categoryData.sc_img && (
                  <img 
                    src={`https://hyre.hyrelancer.com/${categoryData.sc_img}`} 
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {categoryData.sc_icon ? (
                    <img src={`https://hyre.hyrelancer.com/${categoryData.sc_icon}`} alt="Category Icon" className="w-24 h-24 object-cover rounded-lg border border-slate-200" />
                  ) : (
                ...
                <div>
                  ...
                  {categoryData.sc_img ? (
                    <img src={`https://hyre.hyrelancer.com/${categoryData.sc_img}`} alt="Category Banner" className="w-full h-auto object-cover rounded-lg border border-slate-200" />
                  ) : (
