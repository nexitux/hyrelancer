...
const PrivacyPolicyPage = () => {
  ...
  const fetchPrivacyPolicy = async () => {
    try {
      setLoading(true);
      const response = await adminApi.get('/cms-pages/Mg==');
      ...
      alert('Error loading Privacy Policy. Please try again.');
    } finally {
      setLoading(false);
    }
  };
            ...
            <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">Manage your privacy policy content</p>
                </div>
              </div>
            </div>
