...
const EditMessage = ({ params }) => {
  ...
  // Fetch existing message data on component mount
  ...
  const handleSave = async (e) => {
    ...
    try {
      const response = await adminApi.put(`/messages/${encodedId}`, {
        body: messageBody
      });
      ...
      if (err.response?.status === 422) {
        ...
        setError(errorMessages.join(' ') || err.response.data.message || 'Failed to update message.');
      } else {
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="px-6 py-4">
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-semibold text-gray-900">Edit Prefilled Message</h1>
          <nav className="flex items-center space-x-2 text-sm text-gray-500">
            <span>Prefilled Messages</span>
            <span>›</span>
            <span className="text-gray-900">Edit Message</span>
          </nav>
        </div>
      </div>
      ...
      <div className="mx-auto px-6 pb-8">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-medium text-gray-900">EDIT PREFILLED MESSAGE</h2>
          </div>
          <form onSubmit={handleSave}>
            <div className="p-6">
              ...
              {/* Rich Text Editor for Preview */}
              <div className="mb-6">
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Rich Text Preview (Optional)
                </label>
                ...
                <p className="mt-2 text-sm text-gray-500">
                  This rich text editor is for preview purposes. The actual message will be saved as plain text.
                </p>
              </div>
