...
export default function AdminProfessionalPage() {
  ...
  const fetchProfessionalData = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://test.hyrelancer.in/api/admin/getFeUProfessional/${userIdBase64}`, {
        method: "GET",
        headers: {
  ...
  const onFinishAll = async (values) => {
    ...
    try {
      ...
      const response = await fetch("https://test.hyrelancer.in/api/admin/storeFeUProfessional", {
        method: "POST",
        headers: {
          "Accept": "application/json",
  ...
  const onFinishProfessional = async (values) => {
    ...
    try {
      ...
      const response = await fetch("https://test.hyrelancer.in/api/admin/updateFeUProfessional", {
        method: "PUT",
        headers: {
          "Accept": "application/json",
          "Content-Type": "application/json",
  ...
  const onFinishEducation = async (values) => {
    ...
    try {
      ...
      const updatePromises = validEducation.map(async (edu) => {
        ...
        const response = await fetch("https://test.hyrelancer.in/api/admin/updateFeUEducation", {
          method: "PUT",
          headers: {
            "Accept": "application/json",
            "Content-Type": "application/json",
  ...
  const onFinishExperience = async (values) => {
    ...
    try {
      ...
      const updatePromises = validExperience.map(async (exp) => {
        ...
        const response = await fetch("https://test.hyrelancer.in/api/admin/updateFeUExperience", {
          method: "PUT",
          headers: {
            "Accept": "application/json",
            "Content-Type": "application/json",
