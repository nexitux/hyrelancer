...
const PortfolioSection = ({ portfolio, portfolioImages, portfolioEx }) => {
  ...
  const processedImages = portfolioImages && portfolioImages.length > 0 
    ? portfolioImages.map((img, index) => ({
        id: img.fpoi_id || index,
        src: img.fpoi_type === 'Image' ? getImageUrl(img.fpoi_path) : null,
        videoUrl: img.fpoi_type === 'Video' ? img.fpoi_path : null,
        type: img.fpoi_type,
        alt: portfolio?.fpo_title || `Portfolio item ${index + 1}`,
        thumbnail: img.fpoi_thumb ? getImageUrl(img.fpoi_thumb) : (
          img.fpoi_type === 'Image' ? getImageUrl(img.fpoi_path) : null
        )
      }))
    : [
        // Fallback images if no portfolio images
        {
          id: 1,
          src: portfolio ? getImageUrl(portfolio.fpo_img) : "https://images.unsplash.com/photo-1551434678-e076c223a692?w=600&h=800&fit=crop",
          type: 'Image',
          alt: portfolio?.fpo_title || "Portfolio showcase",
          thumbnail: portfolio ? getImageUrl(portfolio.fpo_img) : "https://images.unsplash.com/photo-1551434678-e076c223a692?w=150&h=200&fit=crop"
        }
      ];
        ...
        {processedImages.length > 0 ? (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="relative bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 rounded-2xl overflow-hidden mb-6 aspect-[4/5]">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-4">
                  {portfolio?.fpo_title || 'Portfolio Showcase'}
                </h3>
                ...
                {portfolioImages && portfolioImages.length > 0 && (
                  <div className="bg-gray-50 rounded-lg p-4 mb-6">
                    <div className="grid grid-cols-2 gap-4 text-center">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-blue-600">
                          {portfolioImages.filter(img => img.fpoi_type === 'Video').length}
                        </div>
              ...
              {/* View All Button */}
              <button className="w-full group flex items-center justify-center px-6 py-3 bg-blue-600 text-white rounded-xl font-semibold transition-all duration-200 hover:bg-blue-700 hover:shadow-md">
