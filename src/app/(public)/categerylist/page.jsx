              ...
              return (
                <div key={subcategory.sc_id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300">
                  ...
                  <div className="relative h-48 overflow-hidden">
                    <img
                      src={subcategory.sc_img ? `https://hyre.hyrelancer.com/${subcategory.sc_img}` : 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80'}
                    ...
                    {subcategory.sc_icon && (
                      <div className="absolute bottom-3 left-3 w-12 h-12 bg-white/90 rounded-lg p-2">
                        <img 
                          src={`https://hyre.hyrelancer.com/${subcategory.sc_icon}`}
                          alt={subcategory.sc_name}
